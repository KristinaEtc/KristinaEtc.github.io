...
4. cостояние устройства и его управление будет отображаться на LCD-экране;
5. логика сигнализации реализуется с помощью микроконтроллера.

Отобразим словесное описание в структурной схеме (рис. 1):

![alt tag](https://github.com/KristinaEtc/KristinaEtc.github.io/blob/master/schemes/1pr.png)
...
6. 10 резистора на 10 КОм (резисторы лишними не бывают). [Подтягивающие резисторы](https://ru.wikipedia.org/wiki/%D0%9F%D0%BE%D0%B4%D1%82%D1%8F%D0%B3%D0%B8%D0%B2%D0%B0%D1%8E%D1%89%D0%B8%D0%B9_%D1%80%D0%B5%D0%B7%D0%B8%D1%81%D1%82%D0%BE%D1%80) нужны для устройств с TTL-logic interface.
...
>Для общего развития: подключение пинов Atmega328 Атмеги к пинам Arduino Uno R3 пожно посмотреть [здесь](http://cdn2.shopium.ua/d/arduino/uploads/ARDUINO_V2.png).
